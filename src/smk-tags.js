...
t.sequence( 'leaflet' )
    ...
    .script( 'lib/leaflet/esri-leaflet-3.0.19.js' )
    .script( 'lib/leaflet/esri-leaflet-renderers-2.1.2.js' )
    .script( 'lib/leaflet/esri-leaflet-legend-compat-src-2.0.1.js' )
    .script( 'lib/leaflet/maplibre-gl-3.6.2.js' )
    .script( 'lib/leaflet/esri-leaflet-vector-4.3.1.js' )
    .script( 'lib/leaflet/esri-leaflet-static-basemap-tile-1.0.0.js' )
