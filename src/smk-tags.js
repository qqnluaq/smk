...
// t.script( 'base-maps',  'smk/base-maps.js' )
// t.group( 'base-map-assets' )
//     .template( 'smk/assets/vector-basemap-night.json' )
//     .template( 'smk/assets/vector-basemap-topo.json' )
//     .template( 'smk/assets/vector-basemap-streets.json' )
//     .template( 'smk/assets/vector-basemap-imagery.json' )
...
t.sequence( 'leaflet' )
    .script( 'lib/leaflet/leaflet-1.9.4.js' )
    .style( 'lib/leaflet/leaflet-1.9.4.css', { inline: false } )
    .script( 'lib/leaflet/esri-leaflet-3.0.19.min.js' )
    .script( 'lib/leaflet/esri-leaflet-renderers-2.1.2.js' )
    .script( 'lib/leaflet/esri-leaflet-legend-compat-src-2.0.1.js' )
    // .script( 'lib/leaflet/maplibre-gl-5.24.0.min.js' )
    .script( 'lib/leaflet/maplibre-gl-3.6.2.min.js' )
    .script( 'lib/leaflet/esri-leaflet-vector-4.3.2.js' )
    .script( 'lib/leaflet/esri-leaflet-static-basemap-tile-1.0.0.min.js' )
