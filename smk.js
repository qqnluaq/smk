...
include.tag( "check-directions",
    {
        ...
        "tags": [
            {
                "url": "smk/tool/directions/check/check-directions.js",
                "loader": "script"
            },
            {
                "url": "smk/tool/directions/check/lib/sortable-1.7.0.min.js",
                "loader": "script"
            },
            {
                "url": "smk/tool/directions/check/lib/vuedraggable-2.16.0.min.js",
                "loader": "script"
            }
        ]
    }
...
include.tag( "tool-directions-route",
    {
        "loader": "group",
        "tags": [
            {
                "url": "smk/tool/directions-route/panel-route.html",
                "loader": "template"
            },
            {
                "url": "smk/tool/directions-route/tool-directions-route.js",
                "loader": "script"
            }
        ]
    }
...
include.tag( "tool-mapimageexport",
    {
        "loader": "group",
        "tags": [
            {
                "url": "smk/tool/mapimageexport/panel-mapimageexport.html",
                "loader": "template"
            },
            {
                "url": "smk/tool/mapimageexport/tool-mapimageexport.css",
                "loader": "style"
            },
            {
                "url": "smk/tool/mapimageexport/tool-mapimageexport.js",
                "loader": "script"
            }
        ]
    }
...
include.tag( "tool-print",
    {
        "loader": "group",
        "tags": [
            {
                "url": "smk/tool/print/panel-print.html",
                "loader": "template"
            },
            {
                "url": "smk/tool/print/tool-print.css",
                "loader": "style"
            },
            {
                "url": "smk/tool/print/tool-print.js",
                "loader": "script"
            }
        ]
    }
...
include.tag( "tool-query-results",
    {
        "loader": "group",
        "tags": [
            {
                "url": "smk/tool/query-results/panel-query-results.html",
                "loader": "template"
            },
            {
                "url": "smk/tool/query-results/tool-query-results.js",
                "loader": "script"
            }
        ]
    }
...
include.tag( "tool-zoomto",
    {
        "loader": "group",
        "tags": [
            {
                "url": "smk/tool/zoomto/panel-zoomto.html",
                "loader": "template"
            },
            {
                "url": "smk/tool/zoomto/tool-zoomto.css",
                "loader": "style"
            },
            {
                "url": "smk/tool/zoomto/tool-zoomto.js",
                "loader": "script"
            }
        ]
    }
        ...
        return ( window.SMK = Object.assign( {
            ...
            CONFIG: {
                ...
                tools: [
                    ...
                    { type: 'zoomto',       enabled: false, order: 13,  position: 'list-menu',                        icon: 'location_searching',   title: 'Zoom To' },
                    { type: 'mapimageexport',enabled: false, order: 13,  position: 'list-menu',                       icon: 'photo_library',        title: 'Export Map Image' }
                ]
            },
            ...
            BUILD: {
                commit:     '8834e6c2efc86e8289b7ebe851a54817154ac940',
                branch:     'master',
                lastCommit: '"2019-10-04 11:47:57 -0700"'.replace( /^"|"$/g, '' ),
